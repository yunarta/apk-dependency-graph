...
public class ArgumentReader {
	...
	public Arguments read() {
		...
		String projectPath = null, resultPath = null, filter = null, configFile = null;
		...
		if (projectPath == null || resultPath == null || (filter == null && configFile == null)) {
			System.err.println("Arguments are incorrect!");
			System.err.println(USAGE_STRING);
			return null;
		}

		if ("nofilter".equals(filter)) {
			filter = null;
		...
		return new Arguments(projectPath, resultPath, filter, configFile);
	}
}
